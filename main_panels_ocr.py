...
main_panels_ocr.py
==================
Ejercicio 3 - OCR de paneles recortados

Algoritmo según el enunciado:
1. Detectar caracteres con adaptiveThreshold + findContours
2. Agrupar caracteres en líneas con RANSAC iterativo
3. Clasificar con el mejor clasificador (LDA+Bayes, 96.20% accuracy)
"""
